...
private fun Player(
    ...
    if (currentEpisode != null) {
        ...
        DisposableEffect(exoPlayer, playEpisode) {
            val mediaUri = currentEpisode.episodeInfo.mediaUrls.firstOrNull() ?: currentEpisode.episodeInfo.uri
...
private fun ElapsedTime(
    ...
    val elapsed = "${timeElapsed.toMinutes()}:${timeElapsed.seconds % 60}"
    val l = "${length.toMinutes()}:${length.seconds % 60}"
    Text(
        text = "$elapsed / $l",
        style = style,
        modifier = modifier,
