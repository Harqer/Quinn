...
export class AndroidSearchResults extends LitElement {
  ...
  render() {
    const artists = [
      { name: this.androidActiveSongArtist || "Beatles", type: "Artist", vibe: "classic pop rock harmonies and vintage chord progressions", img: "https://images.unsplash.com/photo-1511671782779-c97d3d27a1d4?w=100&auto=format&fit=crop&q=60" },
