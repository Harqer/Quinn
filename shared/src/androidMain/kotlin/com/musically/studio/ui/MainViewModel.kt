...
class MainViewModel @Inject constructor(
    ...
    internal fun setupMediaAssetCollector() {
        // Media assets (cover art / video motion) are now generated by handling Gemini tool calls.
        // We will update _currentCoverUrl and _currentVideoUrl based on those tool call outcomes.
    }
    ...
    fun launchStripePortal(returnUrl: String = "lyria://settings") {
        viewModelScope.launch {
            ...
            Timber.w("launchStripePortal is deprecated without external backend")
