...
- **Data Type**: MUSIC
  *Description: A user’s music files.*
  - `../dist/assets/AlbumView-B_3aTMqr.js (Pattern: artist)`
- `../dist/assets/DevicesScreen-DSoPqcSl.js (Pattern: track)`
- `../dist/assets/HomeScreen-BaKciP5m.js (Pattern: artist)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/worker_data_safety_part_1.json`.
