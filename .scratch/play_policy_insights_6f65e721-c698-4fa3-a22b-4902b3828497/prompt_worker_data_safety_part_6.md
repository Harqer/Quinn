...
- **Data Type**: OTHER_AUDIO
  *Description: Any other user-created or user-provided audio files.*
  - `../src/repositories/SpotifyRepository.ts (Pattern: podcast)`
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `../dist/assets/LibraryScreen-702Azbnf.js (Pattern: .email)`
- `../dist/assets/index-CYwsE8vb.js (Pattern: .email)`
- `../src/routes/auth.ts (Pattern: .email)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `../dist/assets/index-CYwsE8vb.js (Pattern: race)`
- `../src/index.ts (Pattern: race)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/worker_data_safety_part_6.json`.
