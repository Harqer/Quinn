...
- `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497`: The temporary scratch directory for this audit.
- `input_file`: `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/input_critic_1.json` contains the
  chunk of findings to verify.

### Instructions

1.  **Read input chunk**: Read the JSON object in
   `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/input_critic_1.json`. The keys (e.g. `"1"`,
   `"2"`, `"3"`) correspond to the finding IDs.
2.  **Verify each finding**:
    -   For each finding, analyze its evidence against the source files in
      `/home/shaolin/lyria/app`.
...
4.  **Save Results**: Save your final "Thin JSON" mapping to
   `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/critic_output_1.json`.
