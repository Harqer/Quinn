...
- **Data Type**: USER_ACCOUNT
  *Description: Identifiers that relate to an identifiable person. For example, an account ID, account number, or account name.*
  - `../dist/assets/LoginScreen-ClkfNdYG.js (Pattern: login)`
- `../dist/assets/index-CYwsE8vb.js (Pattern: login)`
- `../package.json (Pattern: uid)`
- **Data Type**: NAME
  *Description: How a user refers to themselves, such as their first or last name, or nickname.*
  - `../src/services/CredentialVerifier.ts (Pattern: given_name)`
- `src/main/java/com/musically/studio/MainActivity.kt (Pattern: family_name)`
- **Data Type**: PHOTOS
  *Description: A user’s photos.*
  - `../src/services/ai.ts (Pattern: CAMERA)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_6f65e721-c698-4fa3-a22b-4902b3828497/worker_data_safety_part_3.json`.
