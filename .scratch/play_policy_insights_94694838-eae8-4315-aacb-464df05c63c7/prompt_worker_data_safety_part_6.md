...
- **Data Type**: FITNESS
  *Description: Information about a user's fitness, such as exercise or other physical activity.*
  - `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/SearchScreen.kt (Pattern: Workout)`
- **Data Type**: PERSONAL_INFO_OTHER
  *Description: Any other personal information such as date of birth, gender identity, veteran status, etc.*
  - `shared/src/androidMain/kotlin/com/musically/studio/network/ApiClient.kt (Pattern: gender)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/onboarding/GenderInputScreen.kt (Pattern: gender)`
- `src/routes/auth.ts (Pattern: gender)`
- **Data Type**: VIDEOS
  *Description: A user’s videos.*
  - `shared/src/androidMain/kotlin/com/musically/studio/ui/MainViewModel.kt (Pattern: MediaRecorder)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `dist/assets/index-Iqq9eRPA.js (Pattern: race)`

**UI Disclosure Starting Points**:
- `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: collect)`
- `app/src/main/java/com/musically/studio/WearableActivity.kt (Pattern: collect)`
- `dist/assets/index-Iqq9eRPA.js (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/MainViewModel.kt (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/CategoryViewScreen.kt (Pattern: share)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/DevicesBottomSheet.kt (Pattern: collect)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/DevicesScreen.kt (Pattern: collect)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/HomeScreen.kt (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/PodcastSelectionScreen.kt (Pattern: collect)`
...
- `src/routes/devices.ts (Pattern: collect)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/worker_data_safety_part_6.json`.
...
2.  **Containment**: Write all artifacts strictly within `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7`.
