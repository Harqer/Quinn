...
- **Data Type**: CRASH_LOGS
  *Description: Crash log data from your app. For example, the number of times your app has crashed, stack traces, or other information directly related to a crash.*
  - `app/src/main/java/com/musically/studio/MyApplication.kt (Pattern: Crashlytics)`
- `dist/assets/index-Iqq9eRPA.js (Pattern: uncaughtException)`
- `shared/src/androidMain/kotlin/com/musically/studio/logging/CrashlyticsTree.kt (Pattern: Crashlytics)`
- **Data Type**: NAME
  *Description: How a user refers to themselves, such as their first or last name, or nickname.*
  - `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: family_name)`
- `src/services/CredentialVerifier.ts (Pattern: given_name)`
- **Data Type**: PHOTOS
  *Description: A user’s photos.*
  - `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: CAMERA)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/worker_data_safety_part_3.json`.
