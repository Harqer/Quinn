...
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `dist/assets/LibraryScreen-4FO9XJ80.js (Pattern: .email)`
- `dist/assets/SearchScreen-By9waXgK.js (Pattern: .email)`
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `dist/assets/DevicesScreen-GY7CbrDm.js (Pattern: localStorage)`
- `dist/assets/index-Iqq9eRPA.js (Pattern: localStorage)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/AlbumViewScreen.kt (Pattern: text/plain)`
- **Data Type**: FITNESS
  *Description: Information about a user's fitness, such as exercise or other physical activity.*
  - `dist/assets/SearchScreen-By9waXgK.js (Pattern: Workout)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/worker_data_safety_part_5.json`.
