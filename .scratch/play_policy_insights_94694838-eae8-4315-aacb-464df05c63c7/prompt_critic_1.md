...
- `input_file`: `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/input_critic_1.json` contains the
  chunk of findings to verify.

### Instructions

1.  **Read input chunk**: Read the JSON object in
   `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/input_critic_1.json`. The keys (e.g. `"1"`,
...
4.  **Save Results**: Save your final "Thin JSON" mapping to
   `/home/shaolin/lyria/.scratch/play_policy_insights_94694838-eae8-4315-aacb-464df05c63c7/critic_output_1.json`.
