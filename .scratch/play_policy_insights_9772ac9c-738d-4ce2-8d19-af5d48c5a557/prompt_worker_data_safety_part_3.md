...
- **Data Type**: CRASH_LOGS
  *Description: Crash log data from your app. For example, the number of times your app has crashed, stack traces, or other information directly related to a crash.*
  - `dist/assets/index-Ds5HevoT.js (Pattern: uncaughtException)`
- `dist/assets/jsx-runtime-KJkY8l8U.js (Pattern: uncaughtException)`
...
- `dist/assets/WelcomeScreen-D1pvxPH2.js (Pattern: Debug)`
- `dist/assets/index-Ds5HevoT.js (Pattern: Debug)`
- **Data Type**: OTHER_AUDIO
  *Description: Any other user-created or user-provided audio files.*
  - `app/src/main/java/com/musically/studio/appfunctions/MaveFunctions.kt (Pattern: podcast)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_3.json`.
