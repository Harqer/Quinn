...
- **Data Type**: PHOTOS
  *Description: A user’s photos.*
  - `dist/assets/ChatScreen-9DCyr41R.js (Pattern: image/*)`
- `shared/src/androidMain/kotlin/com/musically/studio/WearableStreamingService.kt (Pattern: CAMERA)`
...
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `dist/assets/ProfileScreen-DyVxHA0U.js (Pattern: .email)`
- `dist/assets/SettingsScreen-C7tIh2vw.js (Pattern: .email)`
- `dist/assets/index-Ds5HevoT.js (Pattern: .email)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_6.json`.
