...
- **Evidence**:
  ...
  - **Account Files**:
    `DeleteAccountScreen-Dmoxd9fK.js,
LoginScreen-DLuFUCR1.js,
AuthScreen.kt,
AuthOptionsScreen.kt,
LoginScreen.kt,
auth.ts,`
...
app/src/main/java/com/musically/studio/service/LiveApiService.kt (Pattern: FirebaseAuth),`
  ...
  - **Deletion signals (Mechanism)**:
    `shared/src/androidMain/kotlin/com/musically/studio/network/ApiClient.kt (Pattern: deleteAccount),
shared/src/androidMain/kotlin/com/musically/studio/ui/MainViewModel.kt (Pattern: deleteAccount),
shared/src/androidMain/kotlin/com/musically/studio/ui/screens/UserProfileScreen.kt (Pattern: deleteAccount),`
