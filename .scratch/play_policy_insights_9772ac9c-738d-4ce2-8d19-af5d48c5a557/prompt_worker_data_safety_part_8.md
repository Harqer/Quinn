...
- **Data Type**: WEB_BROWSING_HISTORY
  *Description: Information about the websites a user has visited.*
  - `dist/assets/ChatScreen-9DCyr41R.js (Pattern: loadUrl)`
- **Data Type**: DEVICE_ID
  *Description: Identifiers that relate to an individual device, browser or app. For example, an IMEI number, MAC address, Widevine Device ID, Firebase installation ID, or advertising identifier.*
  - `dist/assets/index-Ds5HevoT.js (Pattern: instanceId)`
...
- **Data Type**: PRECISE_LOCATION
  *Description: User or device physical location within an area less than 3 square kilometers, such as location provided by Android’s ACCESS_FINE_LOCATION permission.*
  - `dist/assets/index-Ds5HevoT.js (Pattern: latitude)`
- **Data Type**: OTHER_APP_PERFORMANCE
  *Description: Any other app performance data excluding crash log data (e.g., stack traces) and diagnostics (e.g., battery life, loading time, latency, or framerate).*
  - `dist/assets/index-Ds5HevoT.js (Pattern: heartbeat)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_8.json`.
