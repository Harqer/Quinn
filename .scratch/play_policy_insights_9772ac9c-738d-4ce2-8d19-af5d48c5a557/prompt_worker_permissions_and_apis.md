...
3. **Naming**: The package name (`mave-studio`) and app label
...
- **Evidence**:
  - `app/src/main/java/com/musically/studio/WearableStreamingService.kt (Pattern: startForeground)`
- `shared/src/androidMain/kotlin/com/musically/studio/WearableStreamingService.kt (Pattern: FOREGROUND_SERVICE)`
- `shared/src/androidMain/kotlin/com/musically/studio/audio/PlaybackService.kt (Pattern: FOREGROUND_SERVICE)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_{{GOAL_NAME}}.json`.
