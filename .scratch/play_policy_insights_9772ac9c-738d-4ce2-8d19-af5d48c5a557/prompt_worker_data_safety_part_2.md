...
- `app/src/main/java/com/musically/studio/WearableStreamingService.kt (Pattern: music)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `dist/assets/index-Ds5HevoT.js (Pattern: race)`
- `index.tsx (Pattern: race)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_2.json`.
