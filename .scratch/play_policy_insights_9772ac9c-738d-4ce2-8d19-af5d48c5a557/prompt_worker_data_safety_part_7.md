...
- **LEGAL** related:
  - `IllegalIdentifier.xml`
- `NameTermsScreen.kt`

**Data Sources to Trace**:
- **Data Type**: PURCHASE_HISTORY
  *Description: Information about purchases or transactions a user has made.*
  - `shared/src/androidMain/kotlin/com/musically/studio/billing/PlayBillingManager.kt (Pattern: purchaseToken)`
...
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `dist/assets/ChatScreen-9DCyr41R.js (Pattern: */*)`
- `dist/assets/index-Ds5HevoT.js (Pattern: localStorage)`
...
- `app/src/main/java/com/musically/studio/WearableStreamingService.kt (Pattern: collect)`
- `dist/assets/AlbumView-D9LESfBn.js (Pattern: share)`
- `dist/assets/ChatScreen-9DCyr41R.js (Pattern: Dialog)`
- `dist/assets/PodcastGeneratorScreen-DzBvKlGU.js (Pattern: share)`
- `dist/assets/index-Ds5HevoT.js (Pattern: share)`
- `dist/assets/jsx-runtime-KJkY8l8U.js (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/network/StreamingApiClient.kt (Pattern: Accept)`
...
- `src/services/StripeService.ts (Pattern: collect)`

## Output schema

Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_7.json`.
...
2.  **Containment**: Write all artifacts strictly within `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557`.
