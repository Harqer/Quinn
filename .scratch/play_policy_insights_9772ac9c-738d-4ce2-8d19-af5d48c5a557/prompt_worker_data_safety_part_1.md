...
- `app/src/main/java/com/musically/studio/service/LiveApiService.kt (Pattern: FirebaseAuth)`
- **Data Type**: CREDIT_DEBIT_BANK_ACCOUNT_NUMBER
  *Description: Information about a user’s financial accounts such as credit card number.*
  - `dist/assets/PremiumPlansScreen-Chmd-9Pm.js (Pattern: stripe)`
- `package.json (Pattern: stripe)`
- `shared/src/androidMain/kotlin/com/musically/studio/dataconnect/GetPaymentHistoryQuery.kt (Pattern: stripe)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_9772ac9c-738d-4ce2-8d19-af5d48c5a557/worker_data_safety_part_1.json`.
