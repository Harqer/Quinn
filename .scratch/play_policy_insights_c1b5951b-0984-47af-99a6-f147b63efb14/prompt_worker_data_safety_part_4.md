...
- `dist/assets/WelcomeScreen-D-Y-pTD_.js (Pattern: Debug)`
- `dist/assets/index-BjcG2aKc.js (Pattern: Debug)`
- **Data Type**: CREDIT_DEBIT_BANK_ACCOUNT_NUMBER
  *Description: Information about a user’s financial accounts such as credit card number.*
  - `dist/assets/PremiumPlansScreen-DWZYzXlL.js (Pattern: stripe)`
- `functions/lib/billing.js (Pattern: stripe)`
- `functions/package.json (Pattern: stripe)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_c1b5951b-0984-47af-99a6-f147b63efb14/worker_data_safety_part_4.json`.
