...
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `.agents/skills/brainstorming/scripts/helper.js (Pattern: sessionStorage)`
- `dist/assets/LiveChatMessage--SXZ4IsC.js (Pattern: */*)`
- `dist/assets/index-BjcG2aKc.js (Pattern: sessionStorage)`
- **Data Type**: MUSIC
...
- `app/src/main/java/com/musically/studio/appfunctions/MaveAppFunctionService.kt (Pattern: MediaSession)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_c1b5951b-0984-47af-99a6-f147b63efb14/worker_data_safety_part_1.json`.
