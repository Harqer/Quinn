...
- **Evidence**:
  ...
  - **Account Files**:
    `DeleteAccountScreen-N05acnAW.js,
LoginScreen-DiG0mZc4.js,
auth.js,
auth.ts,
SeedAuthorMutation.kt,
MainViewModel+Auth.kt,
AccountActionCard.kt,
SocialLoginButtons.kt,
DeleteAccountDialog.kt,
LoginForm.kt,
UserAccountActions.kt,
...
LocalAccountsDataProvider.kt,`
  ...
  - **Account Signals**:
    `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: CredentialManager),
app/src/main/res/values/themes.xml (Pattern: FirebaseAuth),
components/lyria_camera_styles.ts (Pattern: uid),`
...
components/lyria_camera_styles.ts (Pattern: uid),`
  ...
  - **Deletion signals (Mechanism)**:
    `shared/src/androidMain/kotlin/com/musically/studio/ui/MainViewModel+Auth.kt (Pattern: deleteAccount),
