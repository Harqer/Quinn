...
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `app/src/main/java/com/musically/studio/appfunctions/MaveAppFunctionService.kt (Pattern: race)`
- `dist/assets/index-BjcG2aKc.js (Pattern: race)`
- `dist/assets/logger-suwgBkNw.js (Pattern: race)`
...
- `dist/assets/index-BjcG2aKc.js (Pattern: Sentry)`
- `dist/assets/jsx-runtime-B-hcVAMW.js (Pattern: uncaughtException)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_c1b5951b-0984-47af-99a6-f147b63efb14/worker_data_safety_part_3.json`.
