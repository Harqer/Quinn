...
- `input_file`: `/home/shaolin/lyria/.scratch/play_policy_insights_30a09be8-51bd-4f09-b9a6-52e6f9cce3a5/input_critic_1.json` contains the
  chunk of findings to verify.

### Instructions

1.  **Read input chunk**: Read the JSON object in
   `/home/shaolin/lyria/.scratch/play_policy_insights_30a09be8-51bd-4f09-b9a6-52e6f9cce3a5/input_critic_1.json`. The keys (e.g. `"1"`,
...
4.  **Save Results**: Save your final "Thin JSON" mapping to
   `/home/shaolin/lyria/.scratch/play_policy_insights_30a09be8-51bd-4f09-b9a6-52e6f9cce3a5/critic_output_1.json`.
