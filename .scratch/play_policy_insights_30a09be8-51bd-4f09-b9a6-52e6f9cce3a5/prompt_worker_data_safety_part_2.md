...
- `dist/assets/WelcomeScreen-DpgDC1E9.js (Pattern: Debug)`
- `dist/assets/index-DCIB1zrB.js (Pattern: Debug)`
- **Data Type**: NAME
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_30a09be8-51bd-4f09-b9a6-52e6f9cce3a5/worker_data_safety_part_2.json`.
