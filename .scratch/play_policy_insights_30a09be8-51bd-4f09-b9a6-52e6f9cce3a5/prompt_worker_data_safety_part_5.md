...
- **Data Type**: FILES_AND_DOCS
  *Description: A user’s files or documents, or information about their files or documents such as file names.*
  - `dist/assets/index-DCIB1zrB.js (Pattern: localStorage)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/DevicesBottomSheet.kt (Pattern: text/plain)`
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `dist/assets/HomeScreen-ChHlF94G.js (Pattern: .email)`
- `dist/assets/LibraryScreen-BO2C-U8y.js (Pattern: .email)`
- `dist/assets/SearchScreen-BGWjSMj3.js (Pattern: .email)`
- **Data Type**: OTHER_AUDIO
  *Description: Any other user-created or user-provided audio files.*
  - `dist/assets/HomeScreen-ChHlF94G.js (Pattern: podcast)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_30a09be8-51bd-4f09-b9a6-52e6f9cce3a5/worker_data_safety_part_5.json`.
