...
- **Data Type**: DEVICE_ID
  *Description: Identifiers that relate to an individual device, browser or app. For example, an IMEI number, MAC address, Widevine Device ID, Firebase installation ID, or advertising identifier.*
  - `dist/assets/index-B3LIVDhd.js (Pattern: instanceId)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/MainViewModel.kt (Pattern: DeviceInfo)`
- **Data Type**: RACE_ETHNICITY
  *Description: Information about a user’s race or ethnicity.*
  - `dist/assets/index-B3LIVDhd.js (Pattern: race)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/ChatViewModel.kt (Pattern: race)`
- **Data Type**: OTHER_APP_PERFORMANCE
  *Description: Any other app performance data excluding crash log data (e.g., stack traces) and diagnostics (e.g., battery life, loading time, latency, or framerate).*
  - `dist/assets/index-B3LIVDhd.js (Pattern: heartbeat)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/worker_data_safety_part_7.json`.
