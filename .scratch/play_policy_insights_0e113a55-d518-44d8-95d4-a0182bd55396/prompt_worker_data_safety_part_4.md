...
- `dist/assets/index-B3LIVDhd.js (Pattern: uncaughtException)`
- `dist/assets/jsx-runtime-bzQ4Vb5N.js (Pattern: uncaughtException)`
...
- `dist/assets/WelcomeScreen-DLdv7AgM.js (Pattern: Debug)`
- `dist/assets/index-B3LIVDhd.js (Pattern: Debug)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/worker_data_safety_part_4.json`.
