...
- **Data Type**: PHOTOS
  *Description: A user’s photos.*
  - `shared/src/androidMain/kotlin/com/musically/studio/ui/CameraPreview.kt (Pattern: CAMERA)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/navigation/EntryProvider.kt (Pattern: ImageCapture)`
- **Data Type**: VIDEOS
  *Description: A user’s videos.*
  - `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: MediaController)`
- `shared/src/androidMain/kotlin/com/musically/studio/WearableStreamingService.kt (Pattern: MediaRecorder)`
- `shared/src/androidMain/kotlin/com/musically/studio/audio/PlaybackService.kt (Pattern: ExoPlayer)`
- **Data Type**: AUDIO
  *Description: A user’s voice such as a voicemail or a sound recording.*
  - `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: RECORD_AUDIO)`
...
- `dist/assets/AlbumView-Qzl12hyO.js (Pattern: share)`
- `dist/assets/PodcastGeneratorScreen-B9ggMB0b.js (Pattern: share)`
- `dist/assets/index-B3LIVDhd.js (Pattern: share)`
- `dist/assets/jsx-runtime-bzQ4Vb5N.js (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/network/ApiClient.kt (Pattern: share)`
- `shared/src/androidMain/kotlin/com/musically/studio/network/MaveSessionManager.kt (Pattern: share)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/ChatViewModel.kt (Pattern: share)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/GenerateCoverScreen.kt (Pattern: collect)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/OnboardingScreen.kt (Pattern: share)`
...
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/UserProfileScreen.kt (Pattern: AlertDialog)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/onboarding/ArtistSelectionScreen.kt (Pattern: collect)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/onboarding/BirthdayInputScreen.kt (Pattern: Dialog)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/onboarding/LoginScreen.kt (Pattern: collect)`
- `shared/src/androidMain/kotlin/com/musically/studio/ui/screens/onboarding/NameTermsScreen.kt (Pattern: Privacy Policy)`
...
- `shared/src/androidUnitTest/kotlin/com/musically/studio/network/fakes/FakeApiClient.kt (Pattern: share)`
- `src/app.ts (Pattern: collect)`
- `src/middlewares/auth.ts (Pattern: collect)`
- `src/repositories/TrackRepository.ts (Pattern: collect)`
- `src/routes/auth.ts (Pattern: collect)`
- `src/routes/logs.ts (Pattern: collect)`
- `src/routes/music.ts (Pattern: share)`
- `src/routes/reports.ts (Pattern: collect)`
- `src/routes/spotify.ts (Pattern: collect)`
- `src/services/MusicService.ts (Pattern: share)`
- `src/services/SpotifyService.ts (Pattern: collect)`

## Output schema

Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/worker_data_safety_part_2.json`.
...
2.  **Containment**: Write all artifacts strictly within `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396`.
