...
- `input_file`: `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/input_critic_2.json` contains the
  chunk of findings to verify.

### Instructions

1.  **Read input chunk**: Read the JSON object in
   `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/input_critic_2.json`. The keys (e.g. `"1"`,
...
4.  **Save Results**: Save your final "Thin JSON" mapping to
   `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/critic_output_2.json`.
