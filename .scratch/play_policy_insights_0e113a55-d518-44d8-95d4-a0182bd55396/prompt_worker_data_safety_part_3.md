...
- **Data Type**: AUDIO
  *Description: A user’s voice such as a voicemail or a sound recording.*
  - `shared/src/androidMain/kotlin/com/musically/studio/WearableStreamingService.kt (Pattern: AudioRecord)`
- `shared/src/androidMain/kotlin/com/musically/studio/logging/CrashlyticsTree.kt (Pattern: record)`
- **Data Type**: MUSIC
  *Description: A user’s music files.*
  - `app/src/main/java/com/musically/studio/MainActivity.kt (Pattern: MediaController)`
- `app/src/main/java/com/musically/studio/MyApplication.kt (Pattern: music)`
- `app/src/main/java/com/musically/studio/appfunctions/MaveFunctions.kt (Pattern: music)`
- **Data Type**: APP_INTERACTIONS
  *Description: Information about how a user interacts with the app. For example, the number of times they visit a page or sections they tap on.*
  - `app/src/main/java/com/musically/studio/MyApplication.kt (Pattern: FirebaseAnalytics)`
...
Save final JSON output to `/home/shaolin/lyria/.scratch/play_policy_insights_0e113a55-d518-44d8-95d4-a0182bd55396/worker_data_safety_part_3.json`.
