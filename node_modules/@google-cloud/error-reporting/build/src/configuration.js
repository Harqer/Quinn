...
class Configuration {
    ...
    _checkLocalServiceContext() {
        ...
        if (this._givenConfiguration.serviceContext?.toString() === '[object Object]') {
            ...
            else if (this._givenConfiguration.serviceContext?.service !== undefined) {
            ...
            else if (this._givenConfiguration.serviceContext?.version !== undefined) {
    ...
    _determineReportMode() {
        if (this._givenConfiguration.reportMode) {
            this._reportMode =
                this._givenConfiguration.reportMode.toLowerCase();
        }
    }
    /**
    ...
    _gatherLocalConfiguration() {
        ...
        if (!isReportModeValid) {
            throw new Error('config.reportMode must a string that is one ' +
                'of "production", "always", or "never".');
        }
        const hasEnvCheck = this._givenConfiguration?.ignoreEnvironmentCheck !== undefined;
        const hasReportMode = this._givenConfiguration?.reportMode !== undefined;
        if (hasEnvCheck) {
            this._logger.warn('The "ignoreEnvironmentCheck" config option is deprecated.  ' +
        ...
        if (hasEnvCheck && hasReportMode) {
            ...
            else if (this._givenConfiguration?.ignoreEnvironmentCheck !== undefined &&
        ...
        else if (this._givenConfiguration?.reportUnhandledRejections !== undefined) {
