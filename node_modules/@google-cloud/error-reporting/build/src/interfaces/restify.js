...
const expressRequestInformationExtractor = require("../request-extractors/express");
/**
...
function serverErrorHandler(client, config, server) {
    server.on('uncaughtException', (req, res, reqConfig, err) => {
        const em = new error_message_1.ErrorMessage().consumeRequestInformation(expressRequestInformationExtractor.expressRequestInformationExtractor(req, res));
