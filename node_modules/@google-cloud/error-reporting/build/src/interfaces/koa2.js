...
exports.koa2ErrorHandler = koa2ErrorHandler;
 ...
 *  request handlers.
 */
function koa2ErrorHandler(client, config) {
    /**
    ...
    return async (ctx, next) => {
        ...
        try {
            ...
            const em = new error_message_1.ErrorMessage()
                .consumeRequestInformation((0, koa_1.koaRequestInformationExtractor)(ctx.request, ctx.response))
