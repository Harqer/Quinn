...
export type Callback = (err: Error | null, response: http.ServerResponse | null, body: {}) => void;
type AnyError = any;
/**
...
export declare function handlerSetup(client: RequestHandler, config: Configuration, logger: Logger): {
    ...
    (err: AnyError, customMessage: string): ErrorMessage;
    (err: AnyError, callback: Callback): ErrorMessage;
    (err: AnyError, request: Request, callback: Callback): ErrorMessage;
    (err: AnyError, request: Request, customMessage: string): ErrorMessage;
    (err: AnyError, customMessage: string, callback: Callback): ErrorMessage;
    (err: AnyError, request: Request, customMessage: string, callback: Callback): ErrorMessage;
};
export {};
