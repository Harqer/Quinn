...
function handlerSetup(config) {
    ...
    function newMessage() {
        ...
        const cleanedStack = (0, build_stack_trace_1.buildStackTrace)('');
        const em = new error_message_1.ErrorMessage().setServiceContext(config.getServiceContext().service, config.getServiceContext().version);
