...
function handlerSetup(client, config, logger) {
    function reportManualError(err, request, customMessage, callback) {
        let em;
        ...
        if (request?.toString() === '[object Object]') {
            ...
            em.consumeRequestInformation((0, manual_1.manualRequestInformationExtractor)(request));
        }
        if (typeof customMessage === 'string') {
            em.setMessage(customMessage);
        }
