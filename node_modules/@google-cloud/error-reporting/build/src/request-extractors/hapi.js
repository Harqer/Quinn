...
const request_information_container_1 = require("../classes/request-information-container");
/**
...
function attemptToExtractStatusCode(req) {
    ...
    if (typeof req.response === 'object') {
        ...
        else if (req.response.output?.toString() === '[object Object]') {
...
function hapiRequestInformationExtractor(req) {
    const returnObject = new request_information_container_1.RequestInformationContainer();
    if (req?.toString() !== '[object Object]' ||
