...
exports.ErrorReporting = exports.ErrorMessage = void 0;
/*!
...
const auth_client_1 = require("./google-apis/auth-client");
// Begin error reporting interfaces
const expressInterface = require("./interfaces/express");
const hapiInterface = require("./interfaces/hapi");
const koaInterface = require("./interfaces/koa");
const koa2Interface = require("./interfaces/koa2");
const manualInterface = require("./interfaces/manual");
const messageBuilderInterface = require("./interfaces/message-builder");
const restifyInterface = require("./interfaces/restify");
...
class ErrorReporting {
    ...
    constructor(initConfiguration) {
        ...
        this._logger = (0, logger_1.createLogger)(initConfiguration);
        ...
        if (this._config.getReportUnhandledRejections()) {
            process.on('unhandledRejection', reason => {
                this._logger.warn('UnhandledPromiseRejectionWarning: ' +
