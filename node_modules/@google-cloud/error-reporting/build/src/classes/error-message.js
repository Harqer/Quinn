...
class ErrorMessage {
    ...
    setResponseStatusCode(responseStatusCode) {
        this.context.httpRequest.responseStatusCode = (typeof responseStatusCode === 'number' ? responseStatusCode : 0);
        return this;
    }
    /**
    ...
    setFilePath(filePath) {
        this.context.reportLocation.filePath = (typeof filePath === 'string' ? filePath : '');
        return this;
    }
    /**
    ...
    setLineNumber(lineNumber) {
        this.context.reportLocation.lineNumber = (typeof lineNumber === 'number' ? lineNumber : 0);
        return this;
    }
    /**
    ...
    setFunctionName(functionName) {
        this.context.reportLocation.functionName = (typeof functionName === 'string' ? functionName : '');
        return this;
    }
    /**
