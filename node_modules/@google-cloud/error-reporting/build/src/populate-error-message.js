...
const build_stack_trace_1 = require("./build-stack-trace");
/**
...
function populateErrorMessage(ob, em) {
    if (ob === null || ob === undefined) {
        em.setMessage((0, build_stack_trace_1.buildStackTrace)('' + ob));
    }
    else if (ob.stack) {
        ...
        em.setMessage((0, build_stack_trace_1.buildStackTrace)(ob.toString()));
    }
    return em;
}
/**
...
function populateFromError(err, errorMessage) {
    ...
    if (err?.serviceContext !== undefined &&
...
function populateFromObject(ob, errorMessage) {
    if (ob?.message !== undefined) {
        ...
        errorMessage.setMessage((0, build_stack_trace_1.buildStackTrace)(util.inspect(ob)));
    }
    ...
    if (ob?.serviceContext !== undefined &&
