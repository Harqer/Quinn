...
fun PodcastDetailScreenLoaded(
    ...
    TransformingLazyColumn(
        ...
        items(episodeList) { episode ->
            MediaContent(
                episode = episode,
                episodeArtworkPlaceholder = androidx.compose.ui.graphics.painter.ColorPainter(androidx.compose.ui.graphics.Color.Gray),
...
fun PodcastDetailsScreenLoadedPreview(
    ...
    PodcastDetailsScreen(
        uiState = PodcastDetailsScreenState.Loaded(
            ...
            podcast = com.musically.studio.ui.jetcaster.core.model.PodcastInfo(uri = "stub", title = "Stub", author = "Stub", imageUrl = ""),
        ),
        onPlayButtonClick = { },
        onEpisodeItemClick = {},
        onPlayEpisode = {},
