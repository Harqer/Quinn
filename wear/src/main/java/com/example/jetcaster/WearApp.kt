    ...
    WearAppTheme {
        AppScaffold {
            SwipeDismissableNavHost(
                ...
                composable("your_podcasts") {
                    PodcastsScreen(
                        onPodcastsItemClick = { navController.navigateToPodcastDetails(it.uri) },
                        onDismiss = { navController.popBackStack() },
                    )
                }
                composable("podcast_details/{podcastUri}") {
                    PodcastDetailsScreen(
                        onPlayButtonClick = {
                            navController.navigateToPlayer()
                        },
                        onEpisodeItemClick = { navController.navigateToEpisode(it.episodeInfo.uri) },
                        onDismiss = { navController.popBackStack() },
                    )
                }
                composable("up_next") {
