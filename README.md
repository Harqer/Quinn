# Quinn - AI Music Studio

Quinn is a real-time, multimodal AI music generation studio that acts as your personal orchestra. It generates original songs based on a variety of inputs, including live video, photos, text prompts, or natural voice commands. 
...
- **Meta Wearables Integration:** Quinn extends to Meta Wearables (like Ray-Ban Meta Smart Glasses) with the same powerful features as the Android app, plus the added ability to use physical gestures (like swipes or taps) to increase the pitch, beats, and other musical elements in real-time.
